...
P = struct(...
    ...
    'smooth_eps', 0,...
    'upper_bound' , 0.9999,...
    'init_image_display',           "img/hbs_seg/output/ins3/init.png",...
    'recounstruced_bound_display',  "img/hbs_seg/output/ins3/reconstructed.png",...
    'seg_display',                  "img/hbs_seg/output/ins3/seg_display.png",...
    'iteration',    100,...
    'u_times',      20,...
    'gaussian',     [0, 5],...
    'eta',          1,...
