...
validateattributes(waypoints,{'numeric'},{'real'},mfilename,'waypoints',1)
validateattributes(time,{'numeric'},{'real'},mfilename,'time',2)
validateattributes(speed,{'numeric'},{'real'},mfilename,'speed',3)
validateattributes(spdtimes,{'numeric'},{'real'},mfilename,'spdtimes',4)
