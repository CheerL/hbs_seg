...
validateattributes(distin,{'numeric'},{'real'},mfilename,'dist',1)
...
% Construct right justified output char matrix with stripped lead spaces
% and stripped padding around formatted string
strout = append(string(prefix),strip(string(str)),string(suffix));
strout = char(strout);
strout = strtrim(strjust(strout));
