...
%      Create a raster reference object using GEORASTERREF or
...
warning(message("map:removing:worldFileMatrixToRefmat", ...
    "worldFileMatrixToRefmat", "GEORASTERREF", "MAPRASTERREF"))
