...
narginchk(2, 4)
warning(message("map:removing:meshgrat","MESHGRAT","geographicGrid","NDGRID"))
...
if min(size(Z)) == 1 && min(size(R)) == 1
    ...
    validateattributes(lat, {'double'}, {'2d','real'}, 'MESHGRAT', 'LAT', 1)
    validateattributes(lon, {'double'}, {'2d','real'}, 'MESHGRAT', 'LON', 2)
