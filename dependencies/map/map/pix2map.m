...
%
%      PIX2MAP will be removed in a future release.
%      Use intrinsicToWorld instead.
%
...
%
%   See also maprefcells, maprefpostings,
...
narginchk(2,3)
nargoutchk(0,2)
warning(message("map:removing:pix2map","PIX2MAP","intrinsicToWorld"))
...
if isobject(R)
    ...
    [x, y] = map.internal.refmatApplyForward(R, row, col);
end
