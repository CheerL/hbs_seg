...
%   Instead, create a geographic raster reference object using
...
warning(message("map:removing:sizem", "SIZEM", "GEOREFCELLS"))

validateattributes(latlim, {'double'}, ...
    {'real','finite','numel',2,'>=',-90,'<=',90}, '', 'latlim')

validateattributes(lonlim, ...
    {'double'}, {'real','finite','numel',2}, '', 'lonlim')

validateattributes(scale, {'double'}, {'real','scalar'}, '', 'scale')
