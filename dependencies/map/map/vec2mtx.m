...
%
%   [Z,R] = VEC2MTX(LAT,LON,Z1,R1) uses a pre-existing data grid Z1,
%   georeferenced by R1, to define the limits and density of the output
%   grid. R1 is a geographic raster reference object. Its RasterSize
%   property must be consistent with size(Z1) and its RasterInterpretation
%   must be 'cells'.
%
%   [Z,REFMAT] = VEC2MTX(LAT,LON,Z1,REFMAT1) and
%   [Z,REFVEC] = VEC2MTX(LAT,LON,Z1,REFVEC1), where REFMAT and REFMAT1 are
%   3-by-2 referencing matrices and REFVEC and REFVEC1 are 1-by-3
%   referencing vectors, will be removed in a future release. Use
%   [Z,R] = VEC2MTX(LAT,LON,Z1,R1) instead, where R and R1 are geographic
...
%   load coastlines
%   [Z,R] = vec2mtx(coastlat,coastlon,1,[-90 90],[-90 270],'filled');
