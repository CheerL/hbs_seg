...
%
%      MAP2PIX will be removed in a future release.
%      Use worldToIntrinsic instead.
%
...
narginchk(2,3)
nargoutchk(0,2)
warning(message("map:removing:map2pix","MAP2PIX","worldToIntrinsic"))
...
if isobject(R)
    ...
    [row, col] = map.internal.refmatApplyInverse(R, x, y);
end
