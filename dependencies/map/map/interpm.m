...
validateattributes(lat, {'numeric'}, {'real'}, 'interpm', 'LAT', 1)
validateattributes(lon, {'numeric'}, {'real'}, 'interpm', 'LON', 2)
validateattributes(maxsep, {'double'}, {'scalar','real'}, 'interpm', 'MAXSEP', 3)
