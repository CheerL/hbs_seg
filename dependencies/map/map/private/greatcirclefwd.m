...
tolerance = 10*map.internal.toleranceInRadians; % Set tolerance
az(phi0 >= pi/2-tolerance) = pi;                % starting at north pole
az(phi0 <= tolerance-pi/2) = 0;                 % starting at south pole
