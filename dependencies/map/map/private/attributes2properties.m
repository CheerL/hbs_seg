...
if ~isnumeric(v)
    % Prior to R2021b, v was limited to be double. However, a
    % geospatial table can have numeric attributes.
    error('map:attributes2properties:nonNumericAttribute', ...
        'Attribute %s contains at least one non-numeric value.', ...
        attributeName)
