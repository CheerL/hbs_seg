...
validateattributes(angin,{'numeric'},{'real'},mfilename,'ANGLE',1)
...
str = [strtrim(d_str) degsymbol(size(angin)) ...
...
str = [strtrim(d_str) degsymbol(size(angin)) spacestr  m_str quotestr];
...
str = [strtrim(str) degsymbol(size(angin))];
