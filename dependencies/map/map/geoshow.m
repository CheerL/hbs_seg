...
%
%   GEOSHOW(LAT, LON) or 
%   GEOSHOW(LAT, LON, ___, 'DisplayType', DISPLAYTYPE, ___) projects and
...
%   defaults to 'line'.
%
%   GEOSHOW(LAT,LON,Z, ___, 'DisplayType', DISPLAYTYPE, ___) projects and
...
%
%   GEOSHOW(Z,R, ___, 'DisplayType', DISPLAYTYPE,___) projects and displays
...
%   GEOSHOW(LAT,LON,RGB)
%   GEOSHOW(___, 'DisplayType', DISPLAYTYPE, ___) projects and displays a
...
%   GEOSHOW(RGB,R) 
%   GEOSHOW(A,CMAP,R) 
%   GEOSHOW(___, 'DisplayType', DISPLAYTYPE, ___) projects and displays an
...
%   be set to 'image'.
%
%   GEOSHOW(S) displays the vector geographic features stored in S as
%   points, multipoints, lines, multilines, polygons, or multipolygons
%   according to the geometry of S. S can be either a geospatial table
%   containing geopointshape, geolineshape, or geopolyshape objects, a
%   geopoint vector, a geoshape vector, or a geostruct (with 'Lat' and
%   'Lon' coordinate fields). The coordinate values are projected to map
%   coordinates. If S is either a mappoint vector, mapshape vector, or a
%   mapstruct (with 'X' and 'Y' fields), vertices are plotted as
%   (pre-projected) map coordinates and a warning is issued. If S is a
%   geospatial table containing mappointshape, maplineshape, or
%   mappolyshape objects an error is issued.
%
%   GEOSHOW(S) or GEOSHOW(S, ___, 'SymbolSpec', SYMSPEC, ___) symbolizes
%   the vector geographic features stored in S. SYMSPEC specifies the
...
%
%   GEOSHOW(AX, ___) sets the axes parent to AX. This is equivalent to 
%   GEOSHOW(___, 'Parent', AX, ___)
%
%   H = GEOSHOW(___) returns a handle to a MATLAB graphics object or, in
...
%   line object.
%
%   GEOSHOW(___, Name, Value) specifies name-value pairs that modify the
...
%   axis off
%
%   See also AXESM, MAKESYMBOLSPEC, MAPSHOW
