    ...
    if nargin > 0
        ...
        switch nargin
            ...
            case {4,6,8}
                ...
                validateattributes(sampleSpacingInLatitude, {'numeric'}, ...
                ...
                validateattributes(sampleSpacingInLongitude, {'numeric'}, ...
...
function latlim = validateLatitudeLimits(latlim)
    validateattributes(latlim, {'numeric'}, ...
...
function lonlim = validateLongitudeLimits(lonlim)
    validateattributes(lonlim, ...
        {'numeric'}, {'real','finite','size',[1 2]}, '', 'lonlim')
