...
%
%      PIX2LATLON will be removed in a future release.
...
%            map.rasterref.GeographicCellsReference/intrinsicToGeographic

% Copyright 1996-2022 The MathWorks, Inc.

narginchk(3,3)
warning(message("map:removing:pix2latlon","PIX2LATLON","intrinsicToGeographic"))
...
if isobject(R)
    ...
    [lon, lat] = pix2map(R, row, col); %#ok<PIX2MAP> 
end
