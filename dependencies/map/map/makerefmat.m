...
%
%      MAKEREFMAT will be removed in a future release. Create a raster
...
warning(message("map:removing:makerefmat", "MAKEREFMAT", ...
    "GEOREFCELLS", "GEOREFPOSTINGS", "MAPREFCELLS", "MAPREFPOSTINGS", ...
    "GEORASTERREF", "MAPRASTERREF"))
if nargin > 0
